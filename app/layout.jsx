...
export const metadata = {
  title: 'Chaitanya Shop - Find the Best Deals Online',
  description: 'Your one-stop affiliate shop for the best deals on electronics, gadgets, and more. Discover featured products and save big!'
};
